...
[Virusparies](https://cran.r-project.org/package=Virusparies) v1.0.0: Implements a visualtion tool for the [VirusHunterGather](https://github.com/lauberlab/VirusHunterGatherer) computational pipeline for data-driven virus discovery from sequencing data from the NIH's [Sequence Read Archive](https://www.ncbi.nlm.nih.gov/sra) or the user's own data. [README](https://cran.r-project.org/web/packages/Virusparies/readme/README.html) points to eleveng vignettes including [VhgBoxplot](https://github.com/SergejRuff/Virusparies?tab=readme-ov-file#virushuntergatherer-plot---vhgboxplot) and [VhgScatterPlot](https://github.com/SergejRuff/Virusparies?tab=readme-ov-file#virushuntergatherer-plot---vhgidentityscatterplot).
...
[plotFTIR](https://cran.r-project.org/package=PlotFTIR) v1.0.0: Implements journal-quality Fourrier Transform Infra-Red (FTIR) spectral plots using `ggplot2`. See the [vignette]https://cran.r-project.org/web/packages/PlotFTIR/vignettes/plotting_ftir_spectra.html).
