...
For a more sophisticated analysis of these series that deals with their multiseasonality aspects see the [Electricity Load Forecast Tutorial](https://nixtlaverse.nixtla.io/statsforecast/docs/tutorials/electricityloadforecasting.html).
