...
alpha1_values <- seq(1, 5, by = 0.2)  # First parameter values to animate
alpha2 <- 1.0  # Keep second parameter constant
...
p <- ggplot(animation_data, aes(x = x1, y = x2)) +
  ...
  labs(
    ...
    subtitle = "α₁ = {closest_state}, α₂ = 1.0, α₃ = 1.0",
    x = "Component 1 (x₁)",
    y = "Component 2 (x₂)",
...
alpha1_comparison <- c(1.0, 1.5, 2.0, 4.0)
alpha2 <- 1.0
alpha3 <- 1.0
n_samples <- 800
